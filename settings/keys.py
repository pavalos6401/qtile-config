...
keys = [
    ...
    Key([k.SUPER], "k", lazy.layout.up(), desc="Move focus up in stack pane"),
    Key([k.SUPER], "j", lazy.layout.down(), desc="Move focus down in stack pane"),
    Key([k.SUPER], "h", lazy.layout.left(), desc="Move focus left in stack pane"),
    Key([k.SUPER], "l", lazy.layout.right(), desc="Move focus right in stack pane"),
    # Move window
    Key(
        [k.SUPER, k.SHIFT],
        "space",
    ...
    Key(
        [k.SUPER], "m", lazy.layout.maximize(), desc="Toggle between min and max sizes"
    ),
    Key(
        [k.SUPER, k.SHIFT],
        "m",
    ...
    Key([k.SUPER, k.SHIFT], "f", float_to_front, desc="Move floating windows to front"),
    # Toggle split
    Key(
        [k.SUPER, k.SHIFT],
        k.ENTER,
    ...
    Key([k.SUPER], "n", lazy.layout.normalize(), desc="Normalize window size ratios"),
    # Close window
    ...
    Key(
        [],
        k.PRINT,
        lazy.spawn(f"'{SCRIPTS}/select-shot-clip.sh'"),
        desc="Clip selected area screenshot",
    ),
    Key(
        [k.SUPER],
        k.PRINT,
        lazy.spawn(f"'{SCRIPTS}/select-shot.sh'"),
        desc="Save selected area screenshot",
    ),
    Key(
        [k.SUPER, k.SHIFT],
        k.PRINT,
        lazy.spawn(f"'{SCRIPTS}/full-shot.sh'"),
